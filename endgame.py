...
def send_email_with_image(image_path):
    ...
    receiver_email = "christian0419@gmail.com"
            ...
            if face_locations:
                ...
                if True in matches:
                    ...
                    if first_match_index < len(known_face_names):
                        ...
                        print("Error: Match index out of range for known_face_names.")
                else:
                    name = "Unknown"
                ...
                if is_real:
                    if name != "Unknown":
                        ...
                        subprocess.call(['python3', '/home/crj/venv/firebase_realtimedb.py'])
                    else:
                        print("Person not recognized. Attempting email alert.")
                        # Send email with image if unknown
                        if time.time() - last_email_time > email_interval:
                            send_email_with_image(image_filename)
                            last_email_time = time.time()

                    # Display the name and face
